...
public class DiaryUI extends JFrame {
    ...
    public DiaryUI() {
        ...
        JButton saveBtn = createStyledButton("저장", new Color(173, 216, 230));      // Light Blue
        JButton loadBtn = createStyledButton("전체 불러오기", new Color(152, 251, 152)); // Pale Green
        JButton deleteBtn = createStyledButton("선택 삭제", new Color(255, 182, 193));    // Light Pink
        JButton searchBtn = createStyledButton("검색", new Color(224, 255, 255));    // Light Cyan
        ...
        // Create a panel for buttons and scroll pane to manage layout correctly
        JPanel mainContentPanel = new JPanel(new BorderLayout(10, 10));
        mainContentPanel.setBackground(bgColor);
        mainContentPanel.setBorder(BorderFactory.createEmptyBorder(0, 15, 10, 15)); // Padding for content panel

        mainContentPanel.add(buttonPanel, BorderLayout.NORTH); // Place buttons at the top of the content panel
        mainContentPanel.add(scrollPane, BorderLayout.CENTER); // Place diary entries list in the center

        add(mainContentPanel, BorderLayout.CENTER); // Add the main content panel to the frame's center
